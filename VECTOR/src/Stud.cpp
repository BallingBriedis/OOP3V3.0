...
bool compareByName(const Stud&, const Stud&) {																			// Rusiavimo funkcijos dalis kuri tikrina vardus.
	return a.getVar() < b.getVar();
}

bool compareBySurname(const Stud&, const Stud&) {																		// Rusiavimo funkcijos dalis kuri tikrina pavardes.
	return a.getPav() < b.getPav();
}

bool compareByFinalGrade(const Stud&, const Stud&) {																	// Rusiavimo funkcijos dalis kuri tikrina galutinius pazymi.
