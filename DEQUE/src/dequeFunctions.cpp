...
void fileRead(deque<Stud>& studentai) {																// Nuskaito duomenis is failo.
...
void fileFilter() {
	deque<Stud> studentai, mokslinciai, vargsai;
	std::stringstream outputas;
...
void fileOutVid(deque<Stud>& studentai) {																					// Isveda i faila pagal vidurki.
	std::stringstream outputas;
...
void fileOutMed(deque<Stud>& studentai) {																					// Isveda i faila pagal mediana.
	std::stringstream outputas;
...
void fileOutVid(deque<Stud>& studentai, string ivestas_vardas) {																					// Isveda i faila pagal vidurki.
	std::stringstream outputas;
	outputas << std::left << std::setw(20) << "Vardas" << std::setw(20) << "Pavarde" << std::setw(20) << "Galutinis (Vid.)" << endl;
	for (auto& a : studentai) {
		outputas << std::left << std::setw(20) << a.var << std::setw(20) << a.pav << std::setw(20) << fixed << setprecision(0) << a.gal << "\n";
...
void fileOutMed(deque<Stud>& studentai, string ivestas_vardas) {																					// Isveda i faila pagal mediana.
	std::stringstream outputas;
	outputas << std::left << std::setw(20) << "Vardas" << std::setw(20) << "Pavarde" << std::setw(20) << "Galutinis (Med.)" << endl;
	for (auto& a : studentai) {
		outputas << std::left << std::setw(20) << a.var << std::setw(20) << a.pav << std::setw(20) << fixed << setprecision(0) << a.gal << "\n";
